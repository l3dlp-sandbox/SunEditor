...
const bl = [
	...
	[
		...
		[
			...
			[':Media-default.more_media', 'image', 'drawing', 'video', 'audio', 'embed'],
			[
				':Galleries & File-default.more_gallery',
				'imageGallery',
				'videoGallery',
				'audioGallery',
				'fileGallery',
...
<div class="se-component se-image-container __se__float-none">
      <figure class="" style="">
        <img src="https://suneditor-files.s3.ap-northeast-2.amazonaws.com/sample/v2/docs/retriever.jpg" alt="Retriever" width="auto" height="auto" data-se-size="auto,auto" data-se-file-name="Retriever" data-se-file-size="0" style="" data-se-index="3">
      </figure>
</div>
  </li>
  <li>bb</li>
...
<div class="se-component se-image-container __se__float-none">
  <figure style="" class="">
    <img src="https://suneditor-files.s3.ap-northeast-2.amazonaws.com/sample/v2/docs/cat.jpg" alt="Tabby" width="auto" height="auto" data-se-size="auto,auto" data-se-file-name="Tabby" data-se-file-size="0" data-se-index="0" style="">
  </figure>
</div>
...
`,
	...
	// <div class="se-component se-image-container __se__float-none">
	//   <figure style="" class="">
	//     <img src="https://suneditor-files.s3.ap-northeast-2.amazonaws.com/sample/v2/docs/welsh Corgi.jpg" alt="Welsh Corgi" style="" width="auto" height="auto" data-se-size="auto,auto" data-se-file-name="Welsh Corgi" data-se-file-size="0" data-se-index="0">
	//   </figure>
	// </div>
	...
	// <div class="se-component se-image-container __se__float-none">
	//       <figure class="" style="">
	//         <img src="https://suneditor-files.s3.ap-northeast-2.amazonaws.com/sample/v2/docs/welsh Corgi.jpg" alt="Welsh Corgi" width="auto" height="auto" data-se-size="auto,auto" data-se-file-name="Welsh Corgi" data-se-file-size="0" style="" data-se-index="0">
	//       </figure>
	// </div>
	//   </li>
	//   <li>dsadsa</li>
	...
	layout: {
		items: [
			{
				name: 'Two Column',
				html: '<div style="display:flex;gap:1em"><div style="flex:1">Left</div><div style="flex:1">Right</div></div>',
			},
		],
	},
	embed: {
...
<figure class="se-flex-component se-input-component se-scroll-figure-x se-figure-selected" style="padding: 0px 1px;width: 280px">
  <table class="se-table-layout-auto" style="border-width: 1px; border-style: solid; border-color: rgb(225, 225, 225); border-collapse: collapse;">
    <colgroup><col style="width: 49.5547px"><col style="width: 55.3672px"><col style="width: 74.9609px"><col style="width: 49.5547px"><col style="width: 49.5625px"></colgroup>
    <tbody>
      <tr>
        ...
        <td class="" style="line-height: 19.5px">
          <div style="line-height: 19.5px">dsadsa</div>
        </td>
        <td style="line-height: 19.5px">
          <div><br>
          </div>
      ...
      <tr>
        ...
        <td style="line-height: 19.5px">
          <div style="line-height: 19.5px">dsa</div>
        </td>
        <td class="" style="line-height: 19.5px">
          <div><br>
          </div>
      ...
      <tr>
        ...
        <td class="" style="line-height: 19.5px">
          <div style="line-height: 19.5px">dsadasdsa</div>
        </td>
        <td style="line-height: 19.5px">
          <div><br>
          </div>
...
<p style="line-height: 19.5px;margin: 0px 0px 10px">​dsadsa</p>

<p style="line-height: 19.5px;margin: 0px 0px 10px">dsa</p>

<div class="se-component se-image-container __se__float-none">
  <figure class="se-figure-selected" style="">
    <img src="https://suneditor-files.s3.ap-northeast-2.amazonaws.com/sample/v2/docs/cat.jpg" alt="Tabby" width="auto" height="auto" data-se-size="auto,auto" data-se-file-name="Tabby" data-se-file-size="0" style="" data-se-index="0">
  </figure>
</div>

<div class="se-component se-video-container __se__float-none" style="width: 100%;">
  <figure style="width: 100%; height: 56.25%; padding-bottom: 56.25%;" class="se-figure-selected">
    <iframe frameborder="0" allowfullscreen="" src="https://www.youtube.com/embed/PTwQ14f3LDM" style="width: 100%; height: 100%;" width="100%" height="56.25%" data-se-size="100%,56.25%" data-se-file-name="PTwQ14f3LDM" data-se-file-size="0" data-se-index="0"></iframe>
  </figure>
</div>

<p style="line-height: 19.5px;margin: 0px 0px 10px">d</p>

<p style="line-height: 19.5px;margin: 0px 0px 10px">​d</p>

<p style="line-height: 19.5px;margin: 0px 0px 10px"><br>
</p>

<p style="line-height: 19.5px;margin: 0px 0px 10px">​sa</p>

<p style="line-height: 19.5px;margin: 0px 0px 10px">​s</p>

<p style="line-height: 19.5px;margin: 0px 0px 10px">ada</p>

<p style="line-height: 19.5px;margin: 0px 0px 10px">asd</p>
...
<p style="line-height: 19.5px;margin: 0px 0px 10px">sad</p>
...
<p style="line-height: 19.5px;margin: 0px 0px 10px">121</p>
...
<p style="line-height: 19.5px;margin: 0px 0px 10px">qe</p>

<p style="line-height: 19.5px;margin: 0px 0px 10px">​2</p>

<p style="line-height: 19.5px;margin: 0px 0px 10px">​f</p>

<p style="line-height: 19.5px;margin: 0px 0px 10px">​f</p>

<p style="line-height: 19.5px;margin: 0px 0px 10px">​g</p>

<p style="line-height: 19.5px;margin: 0px 0px 10px">2g4</p>

<p style="line-height: 19.5px;margin: 0px 0px 10px">24</p>

<p style="line-height: 19.5px;margin: 0px 0px 10px">g2</p>

<p style="line-height: 19.5px;margin: 0px 0px 10px">h</p>

<p style="line-height: 19.5px;margin: 0px 0px 10px">h4</p>

<p style="line-height: 19.5px;margin: 0px 0px 10px">hh</p>

<p style="line-height: 19.5px;margin: 0px 0px 10px">2h</p>

<p style="line-height: 19.5px;margin: 0px 0px 10px">h2</p>

<p style="line-height: 19.5px;margin: 0px 0px 10px">42h</p>

<p style="line-height: 19.5px;margin: 0px 0px 10px">42</p>

<p style="line-height: 19.5px;margin: 0px 0px 10px">h42</p>
...
<p style="line-height: 19.5px;margin: 0px 0px 10px">4h</p>

<p style="line-height: 19.5px;margin: 0px 0px 10px">​h</p>

<p style="line-height: 19.5px;margin: 0px 0px 10px">​24</p>

<p style="line-height: 19.5px;margin: 0px 0px 10px">h<br>
</p>
...
​</li>
          ...
          <li>​dsadsa</li>
          <li>
            <figure class="se-flex-component se-input-component se-scroll-figure-x" style="padding: 0px 1px;width: 280px">
              <table class="se-table-layout-auto" style="border-width: 1px;border-style: solid;border-color: rgb(225, 225, 225);border-collapse: collapse">
                <colgroup><col style="width: 49.5547px"><col style="width: 55.3672px"><col style="width: 74.9609px"><col style="width: 49.5547px"><col style="width: 49.5625px"></colgroup>
                <tbody>
                  <tr>
...
// 	// 			// <div class="se-component se-image-container __se__float-none">
// 	// 			// <figure>
// 	// 			// 	<img src="https://suneditor-files.s3.ap-northeast-2.amazonaws.com/sample/v2/docs/cat.jpg" alt="Tabby" data-se-size="auto,auto" data-se-file-name="cat.jpg" data-se-file-size="0" style="" data-se-index="0">
// 	// 			// </figure>
// 	// 			// </div>
...
// 		await delayedFunction();
// 		handler('https://suneditor-files.s3.ap-northeast-2.amazonaws.com/sample/v2/docs/cat.jpg');
// 	};
